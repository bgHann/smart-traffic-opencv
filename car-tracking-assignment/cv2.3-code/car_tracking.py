...
# ------------------ Main Program ------------------
cap = cv2.VideoCapture("D:\\GIAHAN\\CN2304CLCA\\smart-traffic-opencv\\car-tracking-assignment\\cv2.3-code\\road.mp4")
car_cascade = cv2.CascadeClassifier("D:\\GIAHAN\\CN2304CLCA\\smart-traffic-opencv\\car-tracking-assignment\\cv2.3-code\\cars.xml")
